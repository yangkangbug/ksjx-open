...
const (
	InventoryService_QueryInventory_FullMethodName = "/api.InventoryService/QueryInventory"
)
...
type InventoryServiceClient interface {
	// 查询库存，根据产品ID返回库存数量
	QueryInventory(ctx context.Context, in *InventoryRequest, opts ...grpc.CallOption) (*InventoryResponse, error)
}
...
func (c *inventoryServiceClient) QueryInventory(ctx context.Context, in *InventoryRequest, opts ...grpc.CallOption) (*InventoryResponse, error) {
...
type InventoryServiceServer interface {
	// 查询库存，根据产品ID返回库存数量
	QueryInventory(context.Context, *InventoryRequest) (*InventoryResponse, error)
...
func (UnimplementedInventoryServiceServer) QueryInventory(context.Context, *InventoryRequest) (*InventoryResponse, error) {
...
func _InventoryService_QueryInventory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).QueryInventory(ctx, req.(*InventoryRequest))
	}
